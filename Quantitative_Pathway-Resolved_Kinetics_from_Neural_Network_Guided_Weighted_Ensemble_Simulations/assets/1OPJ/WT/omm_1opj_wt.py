...
class OpenMMRunner:
    def __init__(self,device = 0):
        ...
        gro_file = GromacsGroFile("/scratch/suman/Dibyendu/New_WEPath/Data/1OPJ/WT/md.gro")
        self.top = GromacsTopFile("/scratch/suman/Dibyendu/New_WEPath/Data/1OPJ/WT/topol.top", periodicBoxVectors=gro_file.getPeriodicBoxVectors(), includeDir=ffdir)
