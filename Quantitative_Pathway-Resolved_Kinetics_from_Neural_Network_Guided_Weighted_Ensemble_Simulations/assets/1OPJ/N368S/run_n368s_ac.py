...
if __name__ == '__main__':
    ...
    initial_positions = []
    for i in range(135):
        u = mda.Universe(f"/scratch/suman/Dibyendu/New_WEPath/Data/1OPJ/N368S/1OPJ_N368S_ac_path/frame_{i}.gro")
    ...
    points = np.load("/scratch/suman/Dibyendu/New_WEPath/Data/1OPJ/N368S/1OPJ_N368S_ac_path/ac_path.npy")
    ...
    config = {
        ...
        'bin_file': 'n368s_bin_ac_algebric_clean1.txt',
        'walkers_file': 'n368s_walker_ac_algebric_clean1.txt',
        'survive_empty': False,
        'warp_function': warp_criteria,
        'warp_kwargs': warp_kwargs,
        'h5_atom_indices' : list(range(0, 4682)),
        'traj_file' : 'full_space_n368s_ac1_algebric_clean.h5'
    }
